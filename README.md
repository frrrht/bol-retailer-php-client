...
This is an open source PHP client for the [Bol.com Retailer API](https://api.bol.com/retailer/public/Retailer-API/v7/releasenotes.html) version 7.

## Installation
This project can easily be installed through Composer:

```
composer require picqer/bol-retailer-php-client "^7"
```
...
If you're migrating from v6 to v7, please have a look at the [Migration guide](https://api.bol.com/retailer/public/Retailer-API/v7/migrationguide/v6-v7/migrationguide.html) to see what has changed.
Or if you're migrating from v5 to v7, please have a look at the [Migration guide](https://api.bol.com/retailer/public/Retailer-API/v7/migrationguide/v5-v7/migrationguide.html) to see what has changed.

## Generated Models and Client
All the Models and Client are generated by the supplied [API specifications by Bol](https://api.bol.com/retailer/public/apispec/v7). By generating these this ensures no typos are made, not every operation needs a test and future (minor) updates to the specifications can easily be applied.
